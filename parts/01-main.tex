...
\begin{itemize}
  \item $a \cdot x \equiv 1 (\mod n)$
  \item That means: $(a \cdot x) \mod n = 1$
  \item \textit{Example:} Compute the inverse of $3$ modulo $7$: We want to determine $x$ such that $3x \equiv 1 (\mod 7)$. An inverse is $5 \equiv 1 (\mod 7)$. Other possibilities are e.g., $12$, $-2$.
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item $e$ and the product $(p-1)(q-1)$ are \textbf{relatively prime}, e.g., $\gcd(e, (p-1)(q-1)) = 1$
    \item $d$ is a \textbf{positive inverse} of $e \mod (p-1)(q-1)$, i.e., $ed \equiv 1 (\mod(p-1)(q-1))$
  \end{itemize}
